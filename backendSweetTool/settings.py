"""
Django settings for backendSweetTool project.
...
INSTALLED_APPS = [
    ...
    'rest_framework',  # Make sure it's 'rest_framework', not 'restframework'
    'toolsweetapp',
]
...
ROOT_URLCONF = 'backendSweetTool.urls'
...
WSGI_APPLICATION = 'backendSweetTool.wsgi.application'
